...
var accordion = function accordion(triggers) {
  var btns = document.querySelectorAll(triggers); // const blocks = document.querySelectorAll(itemsSelector);
...
var drop = function drop() {
  ...
  //dragover - срабатывает каждые несколько миллисекунд, когда объект перетаскивают над dropArea
  //dragstart *
  //drop - когда отпускают кнопку мыши и объект отправлен в dropArea
...
var filter = function filter() {
  ...
  function doEvent(trigger, func, selector) {
    trigger.addEventListener('click', function () {
      func(selector);
    });
  }

  doEvent(btnAll, typeFilter, markAll);
  doEvent(btnLovers, typeFilter, markLovers);
  doEvent(btnChef, typeFilter, markChef);
  doEvent(btnGirl, typeFilter, markGirl);
  doEvent(btnGuy, typeFilter, markGuy);
  doEvent(btnGrandmother, typeFilter);
  doEvent(btnGranddad, typeFilter);
...
var modals = function modals() {
  ...
  function bindModal(triggerSelector, modalSelector, closeSelector) {
    ...
    triggers.forEach(function (trigger) {
      // trigger.classList.add('animated','pulse','animate__infinite','infinite');
